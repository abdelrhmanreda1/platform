    ...
    <nav className="bg-white px-6 py-4 sticky top-0 left-0 z-50 border-b-2 border-[#B3C5CE]">
      <div className="w-[90%] mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-6 relative">
          ...
          {role === "Company" ? <img onClick={() => navigate("/dashboard/yourProfile")} src="/company.png" alt="Company Profile" className="w-10 h-10 rounded-full cursor-pointer" /> : <img onClick={() => navigate("/dashboard/yourProfile")} src="/profile.png" alt="User Profile" className="w-10 h-10 rounded-full cursor-pointer" />}
