  ...
  return (
    <div className="bg-white shadow-lg mb-8 p-4 rounded-lg">
      <div className="flex items-center gap-4">
        ...
        <input onClick={() => setIsModalOpen(true)} type="text" placeholder="Write a post!" className="w-[80%] border border-gray-300 rounded-full px-4 py-2 focus:outline-none" />
      </div>
      ...
      <CreatePostModal onPost={onPost} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </div>
  );
};
