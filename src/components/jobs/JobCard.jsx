...
const JobCard = ({ job }) => {
  ...
  return (
    <div className="border-2 border-[#B3C5CE] rounded-2xl p-4 w-full h-full flex flex-col">
      {" "}
      ...
      <div className="flex justify-between items-center mt-3">
        ...
        <button onClick={() => navigate(`/dashboard/jobs/${job.id}`)} className="bg-main text-white rounded-2xl px-8 py-2">
          Apply
        </button>
      </div>
    </div>
